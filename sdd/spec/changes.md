...
- SDD transition complete. 7 triage items resolved (1 corrected, 6 accepted, 0 lost). New REQ-FILES-004 codifies the server-side file-expiration limit; new CON-PLATFORM-002 codifies the template-default applicationId and its lockstep rename list.
